...
class _ArmorState extends State<Armor> {
  ...
  List<dynamic> filteredNames = name_armor;
  bool _up = true;
            ...
            actions: [
              IconButton(onPressed: () {
                setState(() {
                  ...
                  filteredNames = name_armor.toList();
                  _up = false;
                  }
                  else{
                      ...
                      itemBuilder: (context, index) {
                        return Column(
                          children: [
                            SizedBox(height: 5),
                            Button_item(
                              type: types_armor[index],
                              name: filteredNames[index],
                              price: low_price_armor[index],
                              update: updated_armor[index],
                              image_link: image_link_armor[index],
                              per_slot: square_armor[index],
                            ),
                          ],
                        );
                      },
