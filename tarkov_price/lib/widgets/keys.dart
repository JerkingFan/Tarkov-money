...
class _KeysState extends State<Keys> {
  ...
  List<dynamic> filteredNames = name_keys;
  bool _up = true;
            ...
            actions: [
              IconButton(onPressed: () {
                setState(() {
                  ...
                  filteredNames = name_keys.toList();
                  _up = false;
                  }
                  else{
                    sortByDescendingPrice();
                    filteredNames = shortName_keys.toList();
                    _up = true;
                  }
                });
            }, 
                      ...
                      itemBuilder: (context, index) {
                        return Column(
                          children: [
                            SizedBox(height: 5),
                            Button_item(
                              type: types_keys[index],
                              name: filteredNames[index],
                              price: low_price_keys[index],
                              update: updated_keys[index],
                              image_link: image_link_keys[index],
                              per_slot: square_keys[index],
                            ),
                          ],
                        );
                      },
